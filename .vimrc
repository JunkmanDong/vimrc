...
" 设置当前行和列高亮显示
set cursorcolumn
set cursorline "cterm=NONE ctermbg=black ctermfg=green guibg=NONE guifg=NONE
"关闭vim一致性原则
set nocompatible
"显示行号
set nu
...
func SetTitle()
	if &filetype == 'sh'
		...
		call append(line(".")+2, "  > Mail			: 3235459847@qq.com")
	...
	if expand("%:e") == 'h'
		call append(line(".")+6, "#ifndef __".toupper(expand("%:r"))."_H")
		call append(line(".")+7, "#define __".toupper(expand("%:r"))."_H")
		call append(line(".")+8, "")
...
" highlight CursorColumn cterm=NONE ctermbg=lack ctermfg=green guibg=NONE guifg=NONE
" highlight CursorColumn cterm=NONE term=bold cterm=bold ctermbg=darkgrey  guibg=NONE guifg=NONE
" 设置当前行高亮，而非下划线
" highlight CursorLine cterm=NONE term=bold cterm=bold  ctermbg=darkgrey guibg=NONE guifg=NONE
highlight CursorLine cterm=NONE cterm=bold ctermbg=darkgrey guibg=NONE guifg=NONE
